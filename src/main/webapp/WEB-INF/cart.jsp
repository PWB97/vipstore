...
<div class="ckeckout">
		...
		<div class="fuckorder">
			...
			<div class="in-check" >
				...
				<c:forEach items="${tmpCartList}" var="tmpCart">
				<div class="productincart">
						<li class="ring-in"><img src="<%=request.getContextPath() %>/images/${tmpCart.product.productPath}" class="img-responsive" alt=""></a>
						</li>
						<li><span>${tmpCart.product.productName}</span></li>
						<li><span class="item_price">${tmpCart.product.productPrice}</span></li>
						<a class="btn btn-primary btn-sm" href="<%=request.getContextPath() %>/tmpcart/number?userId=${tmpCart.userId}&productId=${tmpCart.product.productId}&quantity=${tmpCart.quantity+1}">+</a>
						${tmpCart.quantity}
						<a class="btn btn-primary btn-sm"  href="<%=request.getContextPath() %>/tmpcart/number?userId=${tmpCart.userId}&productId=${tmpCart.product.productId}&quantity=${tmpCart.quantity-1}">-</a>
						<a class="btn btn-danger btn-sm" href="<%=request.getContextPath() %>/tmpcart/delete?userId=${tmpCart.userId}&productId=${tmpCart.product.productId}">x</a>
					<div class="clearfix"> </div>
				</div>
				</c:forEach>
				</>
		...
		<ul><li><span><a href="<%=request.getContextPath() %>/order/addOrder.html" class="add-cart cart-check item_add">提交到订单</a></span></li></ul>	
		</div>
