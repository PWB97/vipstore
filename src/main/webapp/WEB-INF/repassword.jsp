...
$(document).ready(function(){
  ...
  var p2=$(" input[ name='renewpassword' ] ").val();
  if(p1!=p2){
  alert($("密码不一致").val());
  }
  });
...
<center><div class="signin">
	<div class="container">
		<div class="signin-main">
			<h1>修改密码</h1>
			<form name="from1" action="<%=request.getContextPath() %>/user/repassword.html" method="post">
                ...
                <br>
                <input type="password"  placeholder="确认密码" name="renewpassword" required/>
                <p style="color:red">
	            	${error }
	            </p>
				<br>
