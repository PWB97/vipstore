...
<div class="single">
   <div class="container">
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="<%=request.getContextPath() %>/images/${Product.productPath}">
				        <div class="thumb-image"> <img src="<%=request.getContextPath() %>/images/${Product.productPath}" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
				    <li data-thumb="<%=request.getContextPath() %>/images/${Product.productPath}">
				         <div class="thumb-image"> <img src="<%=request.getContextPath() %>/images/${Product.productPath}" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
			...
			<div class="col-md-7 single-top-left simpleCart_shelfItem">
				...
				<h6 class="item_price">${Product.productPrice}</h6>			
		...
		<!-- 		<ul class="bann-btns">
					...
					<li><a href="#" class="item_add">添加购物车</a></li>					
	            </ul>-->
			</div>
		   <div class="clearfix"> </div>
	   </div>
