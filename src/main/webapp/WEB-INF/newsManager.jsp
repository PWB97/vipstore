    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
				...
				<div class="meun-item meun-item-active" href="#stud1" aria-controls="stud1" role="tab" data-toggle="tab"><img src="<%=request.getContextPath() %>/images/icon_card_grey.png">资讯信息</div>
            </div>
            <!-- 右侧具体内容栏目 -->
        <div id="rightContent">
        ...
        <div class="tab-content">       
			...
			<!--资讯管理模块-->
            <div role="tabpanel" class="tab-pane" id="stud1">
				<div class="check-div">
                            <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addChar">添加资讯</button>
                        </div>
                <div class="data-div">
                    ...
                    <c:forEach items="${newsList}" var="news">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <a class="btn btn-danger btn-xs" href="<%=request.getContextPath() %>/deleteNews?newsId=${news.newsId}">删除</a>
                                <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#changeNews${news.newsId}">修改</button>
                            </div>
                        </div>
                    	</div>
                    	<div class="modal fade" id="changeNews${news.newsId}" role="dialog" aria-labelledby="gridSystemModalLabel">
		                    <div class="modal-dialog" role="document">
		                        <div class="modal-content">
		                            ...
		                            <form action="<%=request.getContextPath() %>/changeNews" method="post">
		                            	<input name="newsId" hidden="hidden" value="${news.newsId}">
			                            ...
			                            <div class="modal-footer">
			                                ...
			                                <input type="submit" class="btn btn-xs btn-danger" value="保存">
			                            </div>
		                            </form>
		                        </div>
		                        <!-- /.modal-content -->
                ...
                <div class="modal fade" id="addChar" role="dialog" aria-labelledby="gridSystemModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<%=request.getContextPath() %>/addNews" method="post">
		                            	<div class="modal-body">
		                                <div class="container-fluid">
		                                	标题
		                                	<input name="title">
