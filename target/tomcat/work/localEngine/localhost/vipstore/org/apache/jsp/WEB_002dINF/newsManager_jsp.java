...
public final class newsManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"meun-item meun-item-active\" href=\"#stud1\" aria-controls=\"stud1\" role=\"tab\" data-toggle=\"tab\"><img src=\"");
      out.print(request.getContextPath() );
      ...
      out.write("          \n");
      out.write("\t\t\t<!--资讯管理模块-->\n");
      out.write("            <div role=\"tabpanel\" class=\"tab-pane\" id=\"stud1\">\n");
      out.write("\t\t\t\t<div class=\"check-div\">\n");
      out.write("                            <button class=\"btn btn-yellow btn-xs\" data-toggle=\"modal\" data-target=\"#addChar\">添加资讯</button>\n");
      out.write("                        </div>\n");
      ...
      // /WEB-INF/newsManager.jsp(101,20) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/newsManager.jsp(101,20) '${newsList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${newsList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/newsManager.jsp(101,20) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\">删除</a>\n");
            out.write("                                <button class=\"btn btn-success btn-xs\" data-toggle=\"modal\" data-target=\"#changeNews");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.newsId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("\">修改</button>\n");
            out.write("                            </div>\n");
            out.write("                        </div>\n");
            out.write("                    \t</div>\n");
            out.write("                    \t<div class=\"modal fade\" id=\"changeNews");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.newsId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("\" role=\"dialog\" aria-labelledby=\"gridSystemModalLabel\">\n");
            out.write("\t\t                    <div class=\"modal-dialog\" role=\"document\">\n");
            out.write("\t\t                        <div class=\"modal-content\">\n");
            out.write("\t\t                            <div class=\"modal-header\">\n");
            out.write("\t\t                                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n");
            out.write("\t\t                                <h4 class=\"modal-title\" id=\"gridSystemModalLabel\">修改</h4>\n");
            out.write("\t\t                            </div>\n");
            out.write("\t\t                            <form action=\"");
            out.print(request.getContextPath() );
            out.write("/changeNews\" method=\"post\">\n");
            out.write("\t\t                            \t<input name=\"newsId\" hidden=\"hidden\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.newsId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("\">\n");
            ...
            out.write("\t\t                                \t</br>\n");
            out.write("\t\t                                \t内容\n");
            out.write("\t\t                                \t<textarea rows=\"10\" cols=\"30\"  name=\"content\"></textarea>\n");
            out.write("\t\t                                </div>\n");
            out.write("\t\t\t                            </div>\n");
            out.write("\t\t\t                            <div class=\"modal-footer\">\n");
            out.write("\t\t\t                                <button type=\"button\" class=\"btn btn-xs btn-white\" data-dismiss=\"modal\">取 消</button>\n");
            out.write("\t\t\t                                <input type=\"submit\" class=\"btn btn-xs btn-danger\" value=\"保存\">\n");
            out.write("\t\t\t                            </div>\n");
            out.write("\t\t                            </form>\n");
            out.write("\t\t                        </div>\n");
      ...
      out.write("                            <div class=\"modal-header\">\n");
      out.write("                                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n");
      out.write("                                <h4 class=\"modal-title\" id=\"gridSystemModalLabel\">添加</h4>\n");
      out.write("                            </div>\n");
      out.write("                            <form action=\"");
      out.print(request.getContextPath() );
      out.write("/addNews\" method=\"post\">\n");
      out.write("\t\t                            \t<div class=\"modal-body\">\n");
      out.write("\t\t                                <div class=\"container-fluid\">\n");
      out.write("\t\t                                \t标题\n");
      out.write("\t\t                                \t<input name=\"title\">\n");
      ...
      out.write("\t\t                                \t</br>\n");
      out.write("\t\t                                \t时间\n");
      out.write("\t\t                                \t<input name=\"createTime\">\n");
      out.write("\t\t                                </div>\n");
      out.write("\t\t\t                            </div>\n");
      out.write("\t\t\t                            <div class=\"modal-footer\">\n");
      out.write("\t\t\t                                <button type=\"button\" class=\"btn btn-xs btn-white\" data-dismiss=\"modal\">取 消</button>\n");
